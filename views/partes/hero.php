...
<section id="hero">
    ...
    <!-- Slider enmascarado por la ola -->
    <div class="hero-derecha-mask">
        <div class="hero-slider">
            <div class="hero-slide active" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-xQKWXtInvky4saKSUIA4qlV_8B2DamV9rVRohjWi4w&s=10');"></div>
            <div class="hero-slide" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSadJeTNZYKCHLKhZ7d6G_YhNw4HqXt1CZWe0HjMoRqaQ&s=10');"></div>
            <div class="hero-slide" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxnuN6mdvSFHuTXvCeJFDXgyU4BGysyOM0MRJq4plcDQ&s=10');"></div>
        </div>
        <div class="ola-filtro-color"></div>
    </div>
    <!-- Ola decorativa -->
    <div class="fondo-ola">
