...
<head>
    ...
    <title>Mis reservas | Dahlia Beauté</title>
    ...
    <link rel="stylesheet" href="../../assets/style/cliente/estilos_misReservas.css">
</head>
<body>
    <header>
        <div class="logo-wrap">
    ...
    <main>
        <div class="contenedor-cliente">
            <div class="cabecera-reservas">
                ...
                <a href="../cliente/reservarCita.php" class="btn-primario">+ Nueva reserva</a>
            </div>

            <div id="lista-reservas"></div>

            <div class="estado-vacio oculto" id="estado-vacio">
                <p>Todavía no tienes reservas.</p>
                <a href="../cliente/reservarCita.php" class="btn-primario">Reserva tu primera cita</a>
            </div>
        </div>
    </main>

    <script src="../cliente/cliente-comun.js"></script>
    <script src="../cliente/misReservas.js"></script>
</body>
</html>
